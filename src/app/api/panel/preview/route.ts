...
export async function POST(request:Request){
	...
	try{
		...
		weather.sensor=layout.blocks.includes('sensor')
			...
			: null
		if(layout.blocks.includes('sensorChart')){
